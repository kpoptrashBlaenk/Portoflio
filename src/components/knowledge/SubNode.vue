<template>
    <!-- Circle -->
    <circle :class="'circleStart' + mainIndex + index" :cx="mainNode.x * 100" :cy="mainNode.y * 100" r="6"
        class="circle">
    </circle>
    <circle :class="'circleEnd' + mainIndex + index" :cx="mainNode.x * 100" :cy="mainNode.y * 100" r="6" class="circle">
    </circle>

    <!-- Line -->
    <line :class="'lineStart' + mainIndex" :x1="mainNode.x * 100" :y1="mainNode.y * 100"
        :x2="(mainNode.x + node.x1) * 100" :y2="(mainNode.y + node.y1) * 100" stroke="red" stroke-width="2"
        stroke-dasharray="150" stroke-dashoffset="150" />
    <line :class="'lineEnd' + mainIndex" :x1="(mainNode.x + node.x1) * 100" :y1="(mainNode.y + node.y1) * 100"
        :x2="(mainNode.x + node.x2) * 100" :y2="(mainNode.y + node.y2) * 100" stroke="red" stroke-width="2"
        stroke-dasharray="150" stroke-dashoffset="150" />
</template>
