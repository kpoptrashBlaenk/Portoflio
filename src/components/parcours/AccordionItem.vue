        ...
        >
          <div class="card-body">
            ...
            <p v-if="doubleItem.focus" class="card-text">
              <strong>Focus:</strong> {{ doubleItem.focus }}
            </p>
            <p v-if="doubleItem.subject" class="card-text">
              <strong>Subject:</strong> {{ doubleItem.subject }}
            </p>
            <p v-if="doubleItem.position" class="card-text">
              <strong>Position:</strong> {{ doubleItem.position }}
            </p>
            <p class="card-text">
              <strong>Location:</strong> {{ doubleItem.location }}
            </p>
            <p class="card-text">
              <strong>Time:</strong> {{ doubleItem.time }}
            </p>
            <p class="card-text">
              <strong>Notes:</strong> {{ doubleItem.notes }}
            </p>
          </div>
        </div>
      </div>
